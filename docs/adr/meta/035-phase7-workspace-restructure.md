...
**Status:** Accepted  
**Date:** 2026-05-28  
**Context:** Phase 7 structural tasks ([TODO.md](../../../.cursor/skills/statix-ebpf-agent/TODO.md)) — rename gateway crate, extract shared utilities, remove dead types. Deferred from [ADR 028](028-finops-wire-and-agent-rename.md).
...
- [ADR 030](../gateway/030-finops-api-config-struct.md) — `statix-gateway/src/config.rs`
