...
| **Target 2** | **Done** | `deploy/clickhouse/01_init.sql` → `statix.workload_metrics` ([ADR 026](026-clickhouse-finops-database-init.md)) |
| **Target 3** | **Done** | `GET /api/v1/workloads/summary` → ClickHouse ([ADR 027](027-api-read-path-clickhouse.md)) |
| 7 | **Done** | Workspace restructure + typed errors + read-only labels ([ADR 028](028-statix-wire-and-agent-rename.md)–[036](036-phase7-typed-errors-labels-read-path.md)) |
