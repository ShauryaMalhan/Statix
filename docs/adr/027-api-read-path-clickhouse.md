...
**Status:** Accepted  
**Date:** 2026-06-04  
**Context:** Target 3 — expose billing-style rollups from `statix.workload_metrics` without a separate query service ([ADR 011](011-replacingmergetree-dedupe-identity.md), [ADR 026](026-clickhouse-finops-database-init.md)).
