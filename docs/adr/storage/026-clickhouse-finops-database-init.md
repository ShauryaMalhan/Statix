...
**Status:** Accepted  
**Date:** 2026-06-04  
**Context:** Target 2 data engineering. Former duplicate `infra/clickhouse/init.sql` was removed; `deploy/clickhouse/01_init.sql` is the only init script ([ADR 007](007-clickhouse-mergetree-tuning.md), [ADR 011](011-replacingmergetree-dedupe-identity.md), [ADR 018](../meta/018-phase-roadmap-status.md)).
...
- [ADR 008](../kafka-legacy/008-clickhouse-kafka-engine-resilience.md)
