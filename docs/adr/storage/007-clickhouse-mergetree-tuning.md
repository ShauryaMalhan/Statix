...
Kafka engine table stays plain `String` columns (JSONEachRow wire format). Kafka consumer resilience — [ADR 008](../kafka-legacy/008-clickhouse-kafka-engine-resilience.md).
