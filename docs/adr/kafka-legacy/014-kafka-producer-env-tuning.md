...
- `finops-api/src/kafka.rs`, [ADR 005](../ingest/005-non-blocking-ingest-pipeline.md), [ADR 012](../gateway/012-finops-api-prometheus-metrics.md) (`statix_api_kafka_channel_full_total`)
