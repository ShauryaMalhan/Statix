...
Storage target (`statix.workload_metrics`) — `ReplacingMergeTree` + sort key — [ADR 007](../storage/007-clickhouse-mergetree-tuning.md), [ADR 011](../storage/011-replacingmergetree-dedupe-identity.md).
