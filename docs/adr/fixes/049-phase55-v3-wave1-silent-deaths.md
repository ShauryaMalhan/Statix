...
- Replaces non-atomic `capacity()` pre-check + per-row `try_send` ([ADR 038](038-phase55-v2-wave1-l8-fixes.md) V2-3 partial mitigation).
...
- `try_reserve_many` preserves non-blocking 503 backpressure ([ADR 005](../ingest/005-non-blocking-ingest-pipeline.md)).
