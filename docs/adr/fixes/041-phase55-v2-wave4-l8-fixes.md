...
- [ADR 025](../deploy/025-kubernetes-gateway-and-agent.md) — K8s manifests + agent RBAC
- [ADR 036](../meta/036-phase7-typed-errors-labels-read-path.md) — K8s merge outside hot path
