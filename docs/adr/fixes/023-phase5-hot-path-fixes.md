...
- Scrape: `http://<node>:9091/metrics` — includes `statix_ring_drops_total` from [ADR 022](../ebpf/022-bpf-ring-buffer-drop-counter.md).
...
- [ADR 019](../gateway/019-ingest-bearer-token-auth.md), [ADR 022](../ebpf/022-bpf-ring-buffer-drop-counter.md)
