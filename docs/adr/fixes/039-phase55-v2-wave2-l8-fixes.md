...
- **V2-12:** Rolling gateway deploys must not re-route nodes across partitions ([ADR 001](../agent/001-use-rustc-hash-for-latency.md) pattern).
...
- [ADR 010](../kafka-legacy/010-kafka-partition-key-by-node.md) — routing (amended: FxHasher)
