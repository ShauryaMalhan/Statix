...
- [ADR 011](../storage/011-replacingmergetree-dedupe-identity.md) — dedupe identity (amended by V2-2)
- [ADR 010](../kafka-legacy/010-kafka-partition-key-by-node.md) — partition routing
