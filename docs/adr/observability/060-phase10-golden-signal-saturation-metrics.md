...
- [ADR 012](../gateway/012-finops-api-prometheus-metrics.md) — gateway metrics baseline
- [ADR 029](../gateway/029-ready-channel-depth-gate.md) — `/ready` 80% threshold
- [ADR 054](../ingest/054-phase11-wal-spillway.md) — WAL spillway
- [ADR 055](../ingest/055-phase13-part1-kafka-removal-rowbinary.md) — queue-less ingest
