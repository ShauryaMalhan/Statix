...
**Status:** Accepted  
**Date:** 2026-05-28  
**Context:** Phase 5 P0 — `EVENTS.reserve()` failure dropped events with no visibility ([phase5-production-readiness.md](../../guides/phase5-production-readiness.md)).
...
3. **Prometheus export:** `metrics-exporter-prometheus` HTTP listener on `0.0.0.0:9091` ([ADR 023](../fixes/023-phase5-hot-path-fixes.md)).
