...
**Status:** Accepted  
**Date:** 2026-06-05  
**Context:** Phase 10 observability — visualize `statix.workload_metrics` in ClickHouse during local dev ([ADR 026](../storage/026-clickhouse-finops-database-init.md)).
