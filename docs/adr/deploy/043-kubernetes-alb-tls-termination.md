...
- **Security:** Bearer token ([ADR 019](../gateway/019-ingest-bearer-token-auth.md)) still required; TLS protects token on the wire.

## References

- [ADR 025](025-kubernetes-gateway-and-agent.md) — gateway Service and Deployment
- [ADR 019](../gateway/019-ingest-bearer-token-auth.md) — ingest bearer auth
