...
**Status:** Accepted  
**Date:** 2026-06-08  
**Context:** Gateway code removed Kafka in Part 1 ([ADR 055](../ingest/055-phase13-part1-kafka-removal-rowbinary.md)); ingest zero-alloc shipped in Part 2 ([ADR 056](../gateway/056-phase13-part2-ingest-zero-alloc.md)). `docker-compose.yml`, K8s gateway Deployment, and deploy READMEs still referenced dead Kafka services and env vars.
...
- [ADR 055](../ingest/055-phase13-part1-kafka-removal-rowbinary.md) — gateway RowBinary ingest
- [ADR 056](../gateway/056-phase13-part2-ingest-zero-alloc.md) — single `MetricRow` hot path
